...
namespace WpfApp6
{
    public partial class Window1 : Window
    {
        ...
        private void BtnTask1_Click(object sender, RoutedEventArgs e)
        {
            ...
            else if (-0.5 >= u1_1 + x1_1 && x1_1 + x1_1 <= Math.Pow(10, -3))
            {
                y1_1 = Math.Cos((Math.Pow(2, u1_1))) - Math.Sin(x1_1 / 3);
            }
            ...
            if (u2_1 + x2_1 > -0.5)
            {
                y2_1 = Math.Pow((2 * u2_1 + 1), 2) / 7 * Math.PI + x2_1;
            }
            else if (-0.5 >= u2_1 + x2_1 && u2_1 + x2_1 <= Math.Pow(10, -3))
            {
                y2_1 = Math.Cos((Math.Pow(2, u2_1))) - Math.Sin(u2_1 / 3);
            }
            else if (u2_1 + x2_1 > Math.Pow(10, -3))
            {
                y2_1 = Math.Log(u2_1 + x2_1) - Math.Pow(x2_1, 2) / 3.5 * x2_1;
            }
            double y3_1, u3_1;
            int x2 = new Random().Next(0, 5);
            //1
            u3_1 = Math.Tan(x2);

            if (u3_1 + x2 > -0.5)
            {
                y3_1 = Math.Pow((2 * u3_1 + 1), 2) / 7 * Math.PI + x2;
            }
            else if (-0.5 >= u3_1 + x2 && u3_1 + x2 <= Math.Pow(10, -3))
            {
                y3_1 = Math.Cos((Math.Pow(2, u3_1))) - Math.Sin(u3_1 / 3);
            }
            else if (u3_1 + x2 > Math.Pow(10, -3))
            {
                y3_1 = Math.Log(u3_1 + x2) - Math.Pow(x2, 2) / 3.5 * x2;
            }
            MessageBox.Show($"y = {u1_1}");
            MessageBox.Show($"y = {u2_1}");
            MessageBox.Show($"y = {u3_1}");
        ...
        private void BtnTask2_Click(object sender, RoutedEventArgs e)
        {
            ...
            a2_1 = 0.2; b2_1 = 0.8; z2_1 = Math.Pow(x2_1, e2_1);
            a2_1 = 0.7; b2_1 = 8.1; z2_1 = 0.8;
            if (x2_1 > 3.5 * a2_1)
            {
            ...
            else if (x2_1 > b2_1)
            {
                ...
                a2_2 = 0.4; b2_2 = 2.3; z2_2 = Math.Pow(2 * x2_2, e2_2);
                a2_2 = 0.2; b2_2 = 0.8; z2_2 = Math.Pow(x2_2, e2_2);
                a2_2 = 0.7; b2_2 = 8.1; z2_2 = 0.8;
                if (x2_2 > 3.5 * a2_2)
                {
                ...
                else if (x2_2 > b2_2)
                {
                    ...
                    a2_3 = 0.4; b2_3 = 2.3; z2_3 = Math.Pow(2 * x2_3, e2_3);
                    a2_3 = 0.2; b2_3 = 0.8; z2_3 = Math.Pow(x2_3, e2_3);
        ...
        private void BtnTask3_Click(object sender, RoutedEventArgs e)
        {
            ...
            MessageBox.Show($"y3_2 = {b3_3}, {m3_3}, {n3_3}");
        }
        private void BtnTask4_Click(object sender, RoutedEventArgs e)
        {
            ...
            MessageBox.Show($"y4_1 = {a4_3}, {b4_3}, {z4_3}");
        }
        ...
        private void BtnTask6_Click(object sender, RoutedEventArgs e)
        {
            ...
            MessageBox.Show($"y6_2 = {a6_2},  {b6_2},  {z6_1}");
        }
        ...
        private void BtnTask24_Click(object sender, RoutedEventArgs e)
        {
            ...
            a24_1 = 9.3; b24_1 = 3.5; z24_1 = Math.Tan(a24_1 * b24_1 * x);
            a24_1 = 2.1; b24_1 = 5.7; z24_1 = Math.Tan(Math.Pow(2, b24_1) * x);
            ...
            a24_2 = 8.7; b24_2 = 3.7; z24_2 = Math.Tan(b24_2 * x);
            a24_2 = 9.3; b24_2 = 3.5; z24_2 = Math.Tan(a24_2 * b24_2 * x);
            a24_2 = 2.1; b24_2 = 5.7; z24_2 = Math.Tan(Math.Pow(2, b24_2) * x);
            ...
            a24_3 = 8.7; b24_3 = 3.7; z24_3 = Math.Tan(b24_3 * x);
            a24_3 = 9.3; b24_3 = 3.5; z24_3 = Math.Tan(a24_3 * b24_3 * x);
        ...
        private void BtnTask20_Click(object sender, RoutedEventArgs e)
        {
            ...
            a20_1 = 1.2; b20_1 = 8.1; f20_1 = Math.Pow(2 * a20_1 * x20_1, e5);
            a20_1 = 3.4; b20_1 = 8.1; f20_1 = Math.Pow(3 * a20_1 * x20_1, e5);
            if (x20_1 <= a20_1)
            {
            ...
            a20_2 = 0.8; b20_2 = 2.4; f20_2 = Math.Pow(1.5 * a20_2 * x20_2, e5);
            a20_2 = 1.2; b20_2 = 8.1; f20_2 = Math.Pow(2 * a20_2 * x20_2, e5);
            a20_2 = 3.4; b20_2 = 8.1; f20_2 = Math.Pow(3 * a20_2 * x20_2, e5);
            if (x20_2 <= a20_2)
            {
            ...
            a20_3 = 0.8; b20_3 = 2.4; f20_3 = Math.Pow(1.5 * a20_3 * x20_3, e5);
            a20_3 = 1.2; b20_3 = 8.1; f20_3 = Math.Pow(2 * a20_3 * x20_3, e5);
            a20_3 = 3.4; b20_3 = 8.1; f20_3 = Math.Pow(3 * a20_3 * x20_3, e5);
            if (x20_3 <= a20_3)
            {
                y20_3 = Math.Pow(a20_3 * x20_3, e7) + f20_3 * Math.Pow(5, Math.Cos(1) * b20_3 * x20_3);
            }
        ...
        private void BtnTask21_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (x21_1 <= a21_1)
            {
                y21_1 = a21_1 * Math.Pow(2, Math.Cos(1)) * b21_1 * Math.Sin(1) * x21_1;
            }
            else if (a21_1 < x21_1 && x21_1 <= 4.5 * b21_1)
            {
                y21_1 = a21_1 * Math.Tan(a21_1 * x21_1) + Math.Pow(2, Math.Sin(1)) * b21_1 * x21_1;
            }
            else if (x21_1 > 4.5 * b21_1)
            {
                y21_1 = Math.Log(a21_1 * x21_1 - b21_1) + Math.Pow(2, 0);
            }
            double y21_2, a21_2, b21_2;

            int x21_2 = new Random().Next(0, 5);


            a21_2 = 8.2; b21_2 = 15.2;

            if (x21_2 <= a21_2)
            {
                y21_2 = a21_2 * Math.Pow(2, Math.Cos(1)) * b21_2 * Math.Sin(1) * x21_2;
            }
            else if (a21_2 < x21_2 && x21_2 <= 4.5 * b21_2)
            {
                y21_2 = a21_2 * Math.Tan(a21_2 * x21_2) + Math.Pow(2, Math.Sin(1)) * b21_2 * x21_2;
            }
            else if (x21_2 > 4.5 * b21_2)
            {
                y21_2 = Math.Log(a21_2 * x21_2 - b21_2) + Math.Pow(2, 0);
            }
            ...
            if (x21_3 <= a21_3)
            {
                y21_3 = a21_3 * Math.Pow(2, Math.Cos(1)) * b21_3 * Math.Sin(1);
            }
            ...
            {
                y21_3 = Math.Log(a21_3 * x21_3 - b21_3) + Math.Pow(2, 0);
            }
            MessageBox.Show($"y21_1 = {a21_1},  {b21_1},");
            MessageBox.Show($"y21_2 = {a21_2},  {b21_2},");
            MessageBox.Show($"y21_1 = {a21_3},  {b21_3},");
        }
